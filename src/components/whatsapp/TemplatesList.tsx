            ...
            <div className="flex gap-2">
              ...
              <div className="text-sm text-amber-800 dark:text-amber-200">
                ...
                <p className="text-amber-700 dark:text-amber-300">
                  Para usar um template, ele deve estar criado e aprovado no Meta Business Suite.
                  Templates UTILITY (transacionais) são mais baratos e têm aprovação mais rápida.
                </p>
              </div>
            </div>
          </div>
